<template>
  <div class="import-step-panel">
    <StepContentHeader :step="step" :step-meta="stepMeta">
      <template #actions>
        <a-button type="primary" size="small" @click="onUpload">
    ...
    <FileUploader
      ...
      @uploaded="onUploaded"
    />
    <div class="import-step-panel__body">
      <ResourceExplorer
        :files="files"
...
import {
  STEP_META_MAP, type PipelineStepType, type PipelineStepState, type FileInfo
...
function onUpload() {
  store.openAndUpload(props.projectId, stepMeta.value.outputDir)
}
...
<style scoped>
.import-step-panel { display: flex; flex-direction: column; flex: 1; min-height: 0; }
.import-step-panel__body {
