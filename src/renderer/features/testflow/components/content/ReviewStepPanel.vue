<template>
  <div class="review-step-panel">
    ...
    <div class="review-step-panel__body">
      <ResourceExplorer
        :files="files"
...
<style scoped>
.review-step-panel { display: flex; flex-direction: column; flex: 1; min-height: 0; }
.review-step-panel__body {
